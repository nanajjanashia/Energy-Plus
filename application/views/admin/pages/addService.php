	 ...
	 <div class="box box-warning">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input id="txt_servicetype" type="text" class="form-control" placeholder="" value="" style="width:50%;">
                </div>		
			</div>
	  ...
	  <div class="box-body">
		<div class="col-md-1">
			<button id="btn-addservice" class="btn btn-block btn-success btn-lg" type="button">Add</button>
		</div>
	  </div>
  </div>	  
</section>
  ...
  <script> 
		...
		$(document).on("click", "#btn-addservice",function(){
		data = new Object();
			...
			$.post(base_url +'/'+ lang + '/admin/saveService',data, function(data,status){
