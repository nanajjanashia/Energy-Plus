...
<head>
  ...
  <title>ENERGYPLUS ADMIN PANEL </title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url("$language/admin");?>" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b>ENERGYPLUS</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img style="background:#fff;" src="<?php echo base_url();?>images/logo.png" class="user-image" alt="User Image">
