	 ...
	 <div class="box box-warning">
            ...
            <div class="box-body">
                <div class="form-group">
				  ...
				  <input id="widget_id" type="hidden" value="<?php echo $widget[0]["id"];?>">
                  <input id="txt_titlege" type="text" class="form-control" placeholder="" value="<?php echo $widget[0]["titlege"];?>" style="width:auto;">
                </div>
				
                <div class="form-group">
                  <label>სათაური ინგლისურად</label>
                  <input id="txt_titleen" type="text" class="form-control" placeholder="" value="<?php echo $widget[0]["titleen"];?>" style="width:auto;">
                </div>					
			</div>
			...
			<div class="box-body">
				...
				<div class="main-upload coversrc"><br>				
					<img src='<?php echo base_url(); ?>images/resource/<?php echo $widget[0]["icon"];?>' width='34px' />
				<br>
				</div>
			</div>
  ...
  <script> 
	...
	$( document ).ready(function() {
		...
		$("#btn-updateWidget").click(function(){
			...
			$.post(base_url +'/'+ lang + '/admin/updateWidget',data, function(data,status){
